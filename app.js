...
app.get('/process_get', function (req, res) {
   ...
   response = {
      ...
      "https://d7c05871-f842-4038-b3f0-9ac5a49c66eb:xXF9DeOI2X@twcservice.mybluemix.net/api/weather/v1/geocode/"+response.latitude+"/"+response.longitude+"/almanac/daily.json?units=e&start="+response.start+"&end="+response.end+"/units=m&language=en-US";
